    ...
    <footer className="bg-black text-white">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="mb-12 text-center">
          <h2 className="text-2xl font-light tracking-[0.3em]">K-YOBOK</h2>
        </div>
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4 mb-12">
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/inventory" className="text-sm text-gray-300 hover:text-white transition-colors">
                  Inventory
                </Link>
              </li>
              <li>
                <Link href="/quality" className="text-sm text-gray-300 hover:text-white transition-colors">
                  Quality
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/my-account" className="text-sm text-gray-300 hover:text-white transition-colors">
                  My account
                </Link>
              </li>
              <li>
                <Link href="/track-order" className="text-sm text-gray-300 hover:text-white transition-colors">
                  Track my order
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="flex items-center gap-4">
              ...
              <Link href="https://pinterest.com" target="_blank" rel="noopener noreferrer" className="text-white hover:text-gray-300 transition-colors">
        ...
        <div className="mb-8">
          ...
          <a href="mailto:kyobokglob@gmail.com " className="text-sm text-gray-300 hover:text-white transition-colors">
