...
export async function Navbar() {
  ...
  return (
    <nav className="border-b-thistle-rose relative flex items-center justify-between border-b-8 p-4 lg:px-6">
      <span className="absolute right-0 -bottom-3.5 left-0 h-1.5 bg-gray-400"></span>
